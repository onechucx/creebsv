<script lang="ts">
	...
	import { ArrowDown, ArrowUp, ArrowsRightLeft, Plus } from 'svelte-hero-icons';
				...
				<div class="p-4">
					...
					<div class="h-64">
						<ResponsiveContainer width="100%" height="100%">
							<LineChart data={selectedWallet.history}>
		...
		<div class="space-y-6">
			<Card>
				<div class="p-4">
					...
					<div class="space-y-3">
						<Button class="w-full justify-center">Fund Wallet</Button>
						<Button variant="secondary" class="w-full justify-center">Buy Rubby</Button>
						<Button variant="secondary" class="w-full justify-center">Sell Rubby</Button>
					</div>
				</div>
			</Card>
		</div>
