		...
		<form on:submit|preventDefault={handleSubmit}>
			<div class="p-6 space-y-6">
				...
				<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
					<div>
						<label for="fullName" class="block text-sm font-medium text-brand-text-secondary"
							>Full Name</label
						>
						<input
							type="text"
					...
					<div>
						<label for="role" class="block text-sm font-medium text-brand-text-secondary"
							>Role</label
						>
						<input
							type="text"
					...
					<div class="md:col-span-2">
						<label for="bio" class="block text-sm font-medium text-brand-text-secondary"
							>Bio</label
						>
						<textarea
							id="bio"
			...
			{#if editMode}
				<div
					class="bg-gray-50 dark:bg-gray-800/50 px-6 py-3 flex justify-end space-x-3 rounded-b-lg"
				>
